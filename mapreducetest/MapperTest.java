...
//This is a custom class which extends a Mapper class as of Hadoop 2.x
//It defines input and output (key, value) pairs of the Mapper class
/**
...
public class MapperTest extends Mapper<LongWritable,Text,Text,IntWritable>{
 	...
 	*/
 	...
 	public void map(LongWritable key,Text value, Context context) throws IOException, InterruptedException{
 		//This split the input Text Object which holds the string on space
 		/**
 		 * Test = "how are you";
 		 * line = {"how", "are", "you"}
 		 */
 		...
 		//Line is a String array of words in a sentence
 		for(String word:line){

 			//Output Map only Job (Text, IntWritable) type & writes ("how", 1), ("are", 1) ("you", 1)
